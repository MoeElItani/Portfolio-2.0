      ...
      <div className='mx-auto flex flex-col items-center justify-center mt-10'>
         ...
         >
            ...
            <input
               type='submit'
               value='Send Message'
               className='button cursor-pointer text-gray-500 dark:text-gray-300 bg-gray-200 hover:bg-emerald-400 focus:ring-4 focus:outline-none focus:ring-transparent font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-800 dark:hover:bg-gray-700  dark:focus:ring-transparent'
            ></input>
